...
CREATE TABLE `Body_type` (
  `idBody_type` int(11) NOT NULL AUTO_INCREMENT,
  `TypeName` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idBody_type`)
...
INSERT INTO `Body_type` VALUES (1,'Hatchback'),(2,'Sedan'),(3,'Coupe'),(4,'Van'),(5,'MUV/SUV'),(6,'Convertible'),(7,'Wagon'),(8,'Jeep');
